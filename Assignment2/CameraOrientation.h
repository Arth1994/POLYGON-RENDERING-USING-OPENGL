...
public:
	...
	CameraOrientation(
		glm::vec3 pos1 = glm::vec3(-1.5, 1.5, 4.7),
	...
	void rotX(GLfloat angle)
	{
		...
		rotationMatrix = glm::rotate(rotationMatrix, angle, this->right);
		this->up = glm::normalize(glm::vec3(rotationMatrix * glm::vec4(up, 1.0)));
	...
	void rotY(GLfloat angle)
	{
		...
		glm::mat4 rotationMatrix(1);
		rotationMatrix = glm::rotate(rotationMatrix, angle, glm::vec3(0.0, 1.0, 0.0));
		this->front = glm::normalize(glm::vec3(rotationMatrix * glm::vec4(front, 1.0)));
	}
	...
	void rotZ(GLfloat angle)
	{
		...
		glm::mat4 rotationMatrix(1);
		rotationMatrix = glm::rotate(rotationMatrix, angle, this->front);
		this->right = glm::normalize(glm::vec3(rotationMatrix * glm::vec4(right, 1.0)));
